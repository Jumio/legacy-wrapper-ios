...
class NetverifyStartViewController: StartViewController, NetverifyViewControllerDelegate {
    ...
    func createNetverifyConfiguration() -> NetverifyConfiguration {
        ...
        //NetverifyPositiveButton.jumioAppearance().setBackgroundImage(UIImage(), for: .normal)
        //NetverifyPositiveButton.jumioAppearance().setBackgroundImage(UIImage(), for: .highlighted)
