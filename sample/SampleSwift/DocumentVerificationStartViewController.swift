...
class DocumentVerificationStartViewController: StartViewController, DocumentVerificationViewControllerDelegate {
    ...
    func createDocumentVerificationController() -> Void {
        ...
        //DocumentVerificationPositiveButton.jumioAppearance().setBackgroundImage(UIImage(), for: .normal)
        //DocumentVerificationPositiveButton.jumioAppearance().setBackgroundImage(UIImage(), for: .highlighted)
